...
The Second Council of Nicaea, held in 787, was a pivotal moment for this tradition. It addressed the Iconoclastic Controversy, where some Byzantine emperors sought to ban religious images. The council affirmed that veneration of icons was legitimate and theologically sound. It clarified that honor given to an image passes to the person it represents. For example, venerating an icon of Christ directs honor to Christ Himself. The council condemned the destruction of icons and upheld their use in worship spaces. This decision relied on both scripture and tradition. The fathers of the council cited John 1:14, which speaks of the Incarnation, as a basis for sacred images. Their ruling shaped Catholic practice for centuries. It remains a cornerstone of the Church’s teaching on this subject.""",
    "holy_oil": """Holy oil, also known as chrism, is a consecrated oil used in various Catholic sacraments, such as baptism, confirmation, and holy orders. Its origins trace back to ancient Israelite practices, where anointing oil was used to sanctify priests and sacred objects, and it has evolved in Christian tradition to symbolize the gift of the Holy Spirit and the consecration of individuals to God's service. Chrism was mentioned by Church Fathers like Tertullian and Hippolytus. 

    In the Old Testament, anointing oil was used to consecrate priests and kings, symbolizing their divine appointment. The biblical recipe for holy anointing oil, as described in Exodus 30:22-25, included ingredients like myrrh, cinnamon, and olive oil.

The Catholic Church recognizes three types of holy oils, each with specific purposes. 

Holy Chrism. Olive oil mixed with balsam. Used in confirmation, holy orders, and the consecration of churches.
Oil of the Sick. Pure olive oil. Used in the Sacrament of Anointing of the Sick for healing and strength.
Oil of Catechumens. Pure olive oil. Used to anoint individuals before baptism, symbolizing preparation and strength.

Each year, during the Chrism Mass, the bishop blesses these oils. They are then distributed to parishes for use throughout the year, symbolizing the unity of the Church and the continuity of sacramental grace.

Holy oils play a vital role in Catholic sacraments. They are seen as a means of grace, marking significant spiritual milestones in a believer's life. The anointing with holy oil signifies a person's commitment to their faith and their role within the Church community.""",
...
Worn around the waist, they symbolize purity, fidelity, and special petitions for protection and grace.""",
    "scapular": """A scapular (from Latin scapula 'shoulder') is a Western Christian garment suspended from the shoulders. There are two types of scapulars, the monastic and devotional scapular; both forms may simply be referred to as "scapular". As an object of popular piety, a devotional scapular serves to remind wearers of their commitment to live a Christian life.
